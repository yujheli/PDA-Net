...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('-t', '--target', type=str, default='dukemtmc', choices=datasets.names())
        self.parser.add_argument('-s', '--source', type=str, default='market1501', choices=datasets.names())
        ...
        self.parser.add_argument('--tar-netG-pretrain', type=str, default='pretrained model path for net_G in stage 2')
        self.parser.add_argument('--netDp-pretrain', type=str, default='pretrained model path for net_Dp in stage 2')
        self.parser.add_argument('--tar-netDi-pretrain', type=str, default='pretrained model path for net_Di in stage 2')
        ...
        self.parser.add_argument('--save-step', type=int, default=2, help='frequency of saving checkpoints at the end of epochs')
        ...
        self.parser.add_argument('--lambda-mmd', type=float, default=1.0, help='loss weight of loss_mmd')
        self.parser.add_argument('--lambda-tri', type=float, default=10.0, help='loss weight of loss_tri')
        self.parser.add_argument('--smooth-label', action='store_true', help='smooth label or not for GANloss')
        self.parser.add_argument('--tri-margin', type=float, default=0.5, help='margin for Tripletloss')
